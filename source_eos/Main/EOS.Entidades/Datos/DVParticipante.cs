...
namespace EOS.Entidades.Datos
{
	public class DVParticipante
	{
        ...
        public DVParticipante()
		{
		}
		public DVParticipante(Int32 _IdPassengerlist)
		{
        ...
        public static ICollection<DVParticipante> ConvertToDto(DataTable dtTable)
        {
            ICollection<DVParticipante> collection = new Collection<DVParticipante>();

            foreach (DataRow row in dtTable.Rows)
            {
                DVParticipante data = new DVParticipante()
                {
