...
{
    /// <summary>
    /// Delegado A Delegado Sin Paraguas
    /// </summary>
    public class FlujoDADSP : IFlujo
    {
        ...
        public bool SometerAmec(CondicionesFlujo condiciones, string idamec, int idPeticionario, int idCreador)
        {
            ...
            try
            {
                ...
                agAmec.InsertarHistorialAmec(estadoSupJer.GetHashCode(), idamec, usuario, NivelesAprobacion.SuperiorJerarquico.GetHashCode(), aprobadores.First().IdAprobador);
                agAmec.InsertarHistorialAmec(estadoNegocio.GetHashCode(), idamec, usuario, NivelesAprobacion.Negocio.GetHashCode(), aprobadores.First().IdPeticionarioManager);
