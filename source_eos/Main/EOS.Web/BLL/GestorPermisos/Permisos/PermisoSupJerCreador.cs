...
{
    public class PermisoSupJerCreador : IPermiso
    {
        public EstadosAmec Estado { get { return EstadosAmec.PendienteSupJerarquicoCreador; } }
        private readonly AgenteAprobadorAmec _agAprobador;

        public PermisoSupJerCreador(AgenteAprobadorAmec agAprobador)
        {
        ...
        public bool Rechazar(string idamec, int idPeticionario)
        {
            ...
            try
            {
                ...
                agAmec.InsertarHistorialAmec(EstadosAmec.Rechazado.GetHashCode(), idamec, usuario, NivelesAprobacion.SupJerarquicoCreador.GetHashCode(), null);
        ...
        public bool Aprobar(string idamec, int idPeticionario, bool condicionado)
        {
            ...
            try
            {
                ...
                DDatosPersonalesUsuario usuario = agUsuarios.ObtenerDatosPersonalesPorIDPeticionario(idPeticionario.ToString());
                agAmec.InsertarHistorialAmec(EstadosAmec.AprobadoSupJerarquicoCreador.GetHashCode(), idamec, usuario, NivelesAprobacion.SupJerarquicoCreador.GetHashCode(), null);
            ...
            catch (Exception ex)
            {
                ...
                agAmec.BorrarHistorialAmec(EstadosAmec.AprobadoSupJerarquicoCreador.GetHashCode(), idamec, idPeticionario, NivelesAprobacion.SupJerarquicoCreador.GetHashCode());
                agAmec.CambiarEstadoAmec(amec.idestado.ToString(), idamec.ToString(), amec.idnivelaprobacion);
                throw;
            }
        }
