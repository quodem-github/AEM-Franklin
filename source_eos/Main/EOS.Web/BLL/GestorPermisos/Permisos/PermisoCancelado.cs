...
{
    public class PermisoCancelado : IPermiso
    {
        public EstadosAmec Estado { get { return EstadosAmec.Cancelado; } }
        private readonly AgenteAprobadorAmec _agAprobador;

        public PermisoCancelado(AgenteAprobadorAmec agAprobador)
        {
