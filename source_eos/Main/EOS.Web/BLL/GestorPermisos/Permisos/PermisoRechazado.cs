...
{
    public class PermisoRechazado : IPermiso
    {
        public EstadosAmec Estado { get { return EstadosAmec.Rechazado; } }
        private readonly AgenteAprobadorAmec _agAprobador;

        public PermisoRechazado(AgenteAprobadorAmec agAprobador)
        {
