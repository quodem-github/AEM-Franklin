<%@ Page Title="" Language="C#" MasterPageFile="~/Styles/EOS.Master" AutoEventWireup="True"
    CodeBehind="NuevoExpedientePasoA.aspx.cs" Inherits="EOS.NuevoExpedientePasoA"
    Culture="es-ES" UICulture="es" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="act" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">

    <script type="text/javascript" src="Scripts/eventosForms.js"></script>
...
<asp:Content ID="Content5" ContentPlaceHolderID="eosContentFilter" runat="server">
    ...
    <asp:Panel ID="plTituloInd" runat="server">
        <h1>Creación expediente individual
        </h1>
    </asp:Panel>
    <asp:Panel ID="plTituloCol" runat="server">
        <h1>Creación expediente colectivo
        </h1>
    </asp:Panel>
    <asp:Panel ID="plTituloCalculadora" runat="server">
        <h1>Calculadora de Honorarios
        </h1>
    </asp:Panel>
    <asp:Panel ID="plPaso1" runat="server">
        ...
        <div id="eosContentFilter">
            <div class="eosTablaFiltros" id="eosFiltroBasico">
                ...
                <h2>Actividad</h2>
                <p>Confirma que la actividad no existe previamente antes de crearla</p>

                <div class="contentFormGeneric">
                    
                    <div class="contentForm  eosTresColumna end-column iconFiltroAvanzadoBox">
                        <a class="iconFiltroAvanzado">Filtro Avanzado</a>
                     </div>
                </div>



                <div class="contentFiltroAvanzado" id="dropAdvancedFilter">
                    <h2>Filtro avanzado</h2>
                    <div class="contentFormGeneric">
                        <div class="contentForm  eosTresColumna end-column">
                            <label class="eosCampoLabel" for="txtNombre">
                                El nombre contiene <div class="tooltip">
                        ...
                        <div class="contentForm  eosTresColumna space-up no-padding-left">
                        ...
                        <div class="contentForm  eosTresColumna space-up">
                    ...
                    <div class="eosBotonera eosBotonFiltrado marginTopBtn">
                        <asp:Button ID="btnCrearNuevaActividad" runat="server" ImageUrl=""
                            PostBackUrl="~/NuevaActividad.aspx" CssClass="btnMorado" Text="Crear nueva actividad" />
                        <asp:Button ID="btnCrearNuevaActividadAmex" runat="server" ImageUrl=""
                            PostBackUrl="~/NuevaActividad.aspx?idconf=3" CssClass="btnMorado" Text="Crear nueva actividad AMEX" />
                 
                        <asp:Button ID="btnCopiarOtroExpediente" runat="server" Text="Copiar de otro expediente" ImageUrl=""
                            PostBackUrl="~/Expedientes.aspx?idsel=1" CssClass="btnMorado" />
                    </div>
                </div>


                <div class="eosBotonera eosBotonFiltrado ">
                    <div> <asp:Button ID="btnCrearNuevaActividadGP" runat="server" ImageUrl=""
  PostBackUrl="~/NuevaActividad.aspx?idconf=1" CssClass="btnMorado" Text="Crear nueva actividad GP" /></div>
                    <div class="space-up"> <asp:Button ID="btnFiltrar" runat="server" ImageUrl=""
     OnClick="btnFiltrar_Click" Text="Filtrar" /></div>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        <td>
                            <asp:ImageButton ID="imgActividadDetalle" runat="server" CommandName="Select" ToolTip='<%# String.Format("Seleccionar Evento {0}", Eval("idcongreso")) %>'
                                OnClientClick='<%# "return TramitarReserva(" + Eval("IdEventoFormulario") + ");" %>' ImageUrl="~/Styles/images/ic_amec.png" />
                        </td>
                        <td class="par">
                        ...
                        <td align="center" <%# (Eval("IdEventoFormulario") != null) ? "style=\"padding:0;\"" : "" %>>
                            ...
                            <asp:ImageButton ID="BtnPost" Visible='<%# Eval("IdEventoFormulario") != null %>'
                                runat="server" AlternateText='<%# String.Format("{0}|{1}", Eval("idCongreso"), Eval("idconfempresa")) %>'
                    ...
                    <tr>
                        <td>
                            <asp:ImageButton ID="imgBtActividadDetalle" class="goMSDBtnClass" runat="server"
                                AlternateText='<%# String.Format("{0}|{1}", Eval("idEventoFormulario"), Eval("idconfempresa")) %>' ToolTip="Ir a gestor de invitados"
    ...
    <asp:Panel ID="pnlVinculado" runat="server" Visible="false">
    ...
    <%--<asp:Panel ID="Panel1" runat="server" Visible="true">
        <div class="eosTituloWizard">
            3º Productos</div>
        <div id="Div1" class="eosFiltroBasico">
            <table class="eosTablaFiltros" id="Table1">
                <tr>
                    <td>
                        <label class="eosCampoLabel" for="xxxFiltroAMEC">
                            Selecciona Producto</label>&nbsp;
                    </td>
                    <td>
                        <asp:DropDownList ID="ddltiposDeProductos" runat="server" CssClass="eosDisabledInputVacio eosInputVacio eosSizeW190"
                            DataTextField="Nombre" DataValueField="IdTipoProducto">
                    ...
                    <td>
                        <asp:TextBox MaxLength="3" ID="TxtPorcentaje" runat="server" ToolTip="Porcentaje"
                            CssClass="eosDisabledInputVacio eosInputVacio eosSizeW35" Width="35"></asp:TextBox>
                    </td>
                    <td>
                        <asp:ImageButton CommandName="Insert" Text="Insertar Nuevo Producto" ID="ImgInsertButton"
                            runat="server" ImageUrl="~/Styles/images/ic_participante_flecha.png" ToolTip="Insertar Nuevo Producto"
                            OnClick="ImgInsertButton_Click" />&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </td>
                    <td>
                        <label class="eosCampoLabel" for="xxxFiltroAMEC">
                            Porcentaje restante
                    ...
                    <td>
                        <asp:TextBox MaxLength="3" ID="txtporcentajerestante" runat="server" ToolTip="Porcentaje restante"
                            CssClass="eosDisabledInputVacio eosInputVacio eosSizeW35" Width="35"></asp:TextBox>
                    </td>
                </tr>
            </table>
    ...
    <div class="eosBotonera eosBotonFiltrado ">
        ...
        <!--<asp:Button ID="btnCancelar" runat="server" ImageUrl=""
            OnClientClick="javascript:document.location.href = 'Expedientes.aspx';return false;"
...
<asp:Content ID="cphScripts" ContentPlaceHolderID="ContentPlaceHolderScripts" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var tipoExpediente = "<%=Request.QueryString["tipo"]%>";
            if (tipoExpediente == "1") {
