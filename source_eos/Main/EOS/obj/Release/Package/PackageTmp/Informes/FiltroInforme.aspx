...
<asp:Content ID="Content6" ContentPlaceHolderID="eosContentFilter" runat="server">
    ...
    <asp:Table ID="Table1" runat="server" CssClass="eosFiltroBasico hidden" Width="935px" BorderWidth="0"
        CellSpacing="0" CellPadding="0">
        <asp:TableRow>
            <asp:TableCell Width="50px">&nbsp;</asp:TableCell>
            <asp:TableCell Width="700px">
                <asp:Table runat="server" CssClass="eosTablaFiltros">
                    <asp:TableRow Height="35px">
                        <asp:TableCell ColumnSpan="2">
                            <asp:Label ID="lbCongreso" runat="server" Text="Congreso"></asp:Label>
                        </asp:TableCell>
                    </asp:TableRow>
