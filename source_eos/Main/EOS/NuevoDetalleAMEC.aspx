<%@ Page Title="Nuevo Amec" Language="C#" MasterPageFile="~/Styles/EOS.Master" AutoEventWireup="true"
    CodeBehind="NuevoDetalleAMEC.aspx.cs" Inherits="EOS.NuevoDetalleAMEC" EnableEventValidation="false"
...
<asp:Content ID="Content1" ContentPlaceHolderID="eosContentFilter" runat="server">
    ...
    <asp:Panel ID="Panel" runat="server">
        <asp:ScriptManager runat="server" ID="scripmanager1" EnablePartialRendering="true">
        </asp:ScriptManager>
        <br />
    ...
    <asp:Panel ID="plAMECDatos1" runat="server">
        ...
        <div id="eosContentFilter">
                    ...
                    <div class="contentForm eosMitadColumna">
                        <label class="eosCampoLabelSin" for="txtAgencias">Agencia<span class="eosCampoObligatorio">*</span> &nbsp;</label>
                         <asp:DropDownList ID="ddlAgencias" runat="server" CssClass="eosDisabledInputVacio eosInputVacio   eosSizeW160"
                            OnSelectedIndexChanged="ddlAgencias_SelectedIndexChanged" AutoPostBack="false" Enabled="true">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="contentFormGeneric">
                    <div class="contentForm radioCheck eosMitadColumna">
                        <asp:Label ID="lblParaguas" runat="server" Text="Paraguas"></asp:Label>
                        <asp:CheckBox ID="chkParaguas" runat="server"
            ...
            <div class="eosTablaFiltros">
                <div class="contentFormGeneric">
                    <div class="contentForm eosMitadColumna">
                        <asp:Label ID="lblPreaprobadaMedico" class="eosCampoLabel" ToolTip="Como norma general, se consideran preaprobados aquellos programas o reuniones que cumplan los requisitos especificados en el punto 4 del Procedimiento AMEC, Programas y Reuniones (revisa dicho Procedimiento en caso de dudas)."
                            runat="server">Preaprobada médico <asp:HyperLink ID="HyperLink1" onclick="javascript:mostrarDescPreMed(this);" runat="server"
    class="eosVerMas contentMoreInfo">+</asp:HyperLink><span class="eosCampoObligatorio">*</span></asp:Label>
                ...
                <div id="DescPreMed" style="display: none">
                    <div>
                        <label id="lblDescPredMed" style="font-style: italic" class="eosCampoLabelSin">
                            ...
                            los requisitos especificados en el punto 4 del Procedimiento AMEC, Programas y Reuniones 
                            (revisa dicho Procedimiento en caso de dudas).</label>
                    </div>
                </div>
                <div class="contentFormGeneric">
                    <div class="contentForm eosMitadColumna">
                ...
                <div class="contentFormGeneric">
                    ...
                    <div class="contentForm eosMitadColumna">
                         <%--<label id="Label2" class="eosCampoLabelSin">
                             Actividad conforme con la política N.20/FCPA<span class="eosCampoObligatorio">*</span></label>--%>
                         <label id="Label2" class="eosCampoLabelSin">
            ...
            <div id="compartiramec" style="margin-top: 10px" class="eosTablaFiltros">
                <div>
                    <span class="eosTituloWizard">UNIDAD ORGANIZATIVA DEL SOLICITANTE</span>
                </div>
                <div class="contentFormGeneric">
                    <div class="contentForm eosMitadColumna">
                        <label class="eosCampoLabelSin" for="txtUnidad">
                            Unidad</label>
                        <asp:DropDownList ID="ddlUnidad" runat="server" CssClass="eosDisabledInputVacio eosInputVacio   eosSizeW160"
                            OnSelectedIndexChanged="ddlUnidad_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator ID="rfvUnidad" runat="server" ErrorMessage="Unidad" ControlToValidate="ddlUnidad"
                            ValidationGroup="AMECValidationGroup" SetFocusOnError="True" ToolTip="Campo Obligatorio">&nbsp;
                        </asp:RequiredFieldValidator>
                    </div>
                    <div class="contentForm eosMitadColumna">
                        <label class="eosCampoLabelSin" for="txtArea">
                            Área</label>
                        <asp:DropDownList ID="ddlArea" runat="server" CssClass="eosDisabledInputVacio eosInputVacio  eosSizeW160"
                            OnSelectedIndexChanged="ddlArea_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="contentFormGeneric">
                    <div class="contentForm eosMitadColumna">
                        <label class="eosCampoLabelSin" for="txtRegion">
                            Región</label>
                        <asp:DropDownList ID="ddlRegion" runat="server" CssClass="eosDisabledInputVacio eosInputVacio eosSizeW160"
                            OnSelectedIndexChanged="ddlRegion_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
                        </asp:DropDownList>
                    </div>
                    <div class="contentForm eosMitadColumna">
                        <label class="eosCampoLabelSin" for="txtDistrito">
                            Distrito</label>
                        <asp:DropDownList ID="ddlDistrito" runat="server" CssClass="eosDisabledInputVacio eosInputVacio eosSizeW160 "
                            OnSelectedIndexChanged="ddlDistrito_SelectedIndexChanged" AutoPostBack="true"
                            Enabled="false">
                        </asp:DropDownList>
                    </div>
                </div>
    ...
    <div id="unidades">
        ...
        <div id="unidades">
            ...
            <asp:Panel ID="plAMECDatos3" runat="server">
                <div class="eosTituloWizard">
                    Este AMEC Aplica a las siguiente Areas de la Empresa
                </div>
                <div id="eosAMECUnidadesOrganizativas" class="eosFiltroColor">
                    <div class="eosFiltroColorTabla contentTableGeneric">
                        <asp:ListView ID="lvUnidadesOrg" runat="server" DataSourceID="odsUnidadesOrganizativas"
                            EnablePersistedSelection="True" OnLoad="lvUnidadesOrg_Load" DataKeyNames="IDAMECS">
                            <EmptyDataTemplate>
                                <table style="margin-top: 20px" class="eosTablaResultados">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="4">
                                                <span class="eosTituloRojo">No se han encontrado Unidades Organizativas que cumplan
                                                    los criterios de búsqueda seleccionados</span>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="eosTablaResultados">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>
                                                <asp:LinkButton ID="lbUnidad" runat="server" Text="UNIDAD" CommandName="Sort" CommandArgument="UNIDAD"></asp:LinkButton>
                                            </th>
                                            <th>
                                                <asp:LinkButton ID="lbAreas" runat="server" Text="AREAS" CommandName="Sort" CommandArgument="AREAS"></asp:LinkButton>
                                            </th>
                                            <th>
                                                <asp:LinkButton ID="lbRegion" runat="server" Text="REGION" CommandName="Sort" CommandArgument="REGION"></asp:LinkButton>
                                            </th>
                                            <th>
                                                <asp:LinkButton ID="lbDistrito" runat="server" Text="DISTRITO" CommandName="Sort"
                                                    CommandArgument="DISTRITO"></asp:LinkButton>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                ...
                                <tr>
                                    <td>
                                        <asp:ImageButton Text="Borrar" ID="ImgDeleteButton" runat="server" ImageUrl="~/Styles/images/ic_participante_aspa.png"
                                            CommandArgument='<%# Eval("idunidadamec") %>' ToolTip="Anular Unidad Organizativa del AMEC"
                                            OnCommand="imgUnidadEliminar_Command" />
                                    </td>
                                    <td class="par">
                                        <asp:Label ID="lbUnidad" runat="server" Text='<%# Eval("unidad") %>' />
                                    </td>
                                    <td>
                                        <asp:Label ID="lbAreas" runat="server" Text='<%# Eval("area") %>' />
                                    </td>
                                    <td class="par">
                                        <asp:Label ID="lbRegion" runat="server" Text='<%# Eval("region") %>' />
                                    </td>
                                    <td>
                                        <asp:Label ID="lbDistrito" runat="server" Text='<%# Eval("distrito") %>' />
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:ListView>
                    ...
                    <asp:UpdatePanel ID="UpdateUnidades" runat="server">
                        <ContentTemplate>
                            <div id="UnidadOrgAnadir" style="margin-top: 10px" class="eosTablaFiltros" width="100%">
                                <div class="contentFormGeneric">
                                    <div class="contentForm eosMitadColumna">
                                        <label class="eosCampoLabelSin" for="txtUnidad">
                                            Unidad</label>
                    ...
                    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdateUnidades">
                        <ProgressTemplate>
                            <div style="z-index: 999999; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background-color: #ccc; opacity: 0.6; vertical-align: middle;" class="ajaxImageClassA">
                                <div style="vertical-align: middle; margin-top: 40%;">
                                    <center>
                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Styles/images/ajax-loader.gif" Title="Cargando..." />
                                        <br />
                    ...
                    <div class="eosBotonera eosBotonFiltrado">
                        <asp:Button ID="btnAnadirUnidadesOrgAMEC" runat="server" Visible="true" Text="Añadir U. Organizativa"
                            OnClick="btnAnadirUnidadesOrgAMEC_Click" />
                    </div>
                </div>
            </asp:Panel>
        </div>
        <asp:Panel ID="plPaso1" runat="server">
            ...
            <div class="eosTituloWizard">
                <div class="contentFormGeneric">
                    <div class="contentForm eosUnoColumna radioCheck">
                        <label style="margin-left: 0;">ASOCIAR AMEC A EVENTO O ACTIVIDAD</label>
                            <asp:CheckBox ID="chkAsociarEvento" onclick="javascript:asociarAmec(this);" runat="server" Text=" " />
                    </div>
                </div>
            </div>
            <% if (AsociarEvento())
            ...
            <div id="AsociarEvento">
                ...
                <div id="AsociarEvento" style="display: none">
                    ...
                    <br />
                    <div id="tituloAsociarEvento" class="eosTituloWizard">
                        Asociar Eventos
                    </div>
                    <div id="AsociarEvento" class="eosFiltroColor">
                        <div class="eosFiltroColorTabla">
                            <div class="eosTablaFiltros">
                                <span class="eosTituloWizard">Filtro de Eventos<br />Rellene los campos necesarios y pulse el botón FILTRAR</span>
                                <div class="contentFormGeneric">
                                    <div class="contentForm eosMitadColumna">
                                ...
                                <div class="contentFormGeneric">
                                    <div class="contentForm eosMitadColumna">
                                        <label class="eosCampoLabel" for="txtFechaDesde">
                                            Desde</label>
                                        ...
                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Styles/images/ic_calendario.png" CssClass="iconCalendar" />
                                    ...
                                    <div class="contentForm eosMitadColumna">
                                        <label class="eosCampoLabel" for="txtFechaHasta">
                                            Hasta</label>
                    ...
                    <div id="eosContentResults" runat="server" visible="false">
        ...
        <asp:Panel ID="Panel8" runat="server">
            ...
            <div id="TablaPrograma" class="contentTableGeneric">
                <asp:ListView ID="lvPrograma" runat="server" DataSourceID="odsProgramaAMEC" EnablePersistedSelection="True"
            ...
            <div id="Div6" class="eosFiltroColor">
                <div class="eosFiltroColorTabla">
                    <table id="Table3" class="eosTablaFiltros">
                        ...
                        <tr id="descripcion">
                            <td>
                                <label id="lblDescProgAMEC" class="eosCampoLabelSin" style="padding-right: 15px; padding-left: 10px">
                ...
                <div class="eosFiltroColorTabla">
                    <div class="eosTablaFiltros">
                        ...
                        <div class="contentFormGeneric">
                            ...
                            <div class="contentForm eosMitadColumna">
                                <label id="lblNumPonentes" class="eosCampoLabelSin" title="Número ponentes patrocinados por MSD">
                        ...
                        <div class="contentFormGeneric">
                            <div class="contentForm eosUnoColumna">
                                ...
                                <asp:DropDownList ID="ddlCriteriosSeleccion" runat="server" CssClass="eosDisabledInputVacio eosInputVacio  eosSizeW800"
                            ...
                            <div class="contentFormGeneric">
                                <div class="contentForm eosUnoColumna">
                                    <label class="eosCampoLabelSin" id="lblMedicosGenesys"
                                        title="El listado definitivo de asistentes se subira a APPIAN sin demora una vez concluida la actividad">Todos los médicos que han sido incluidos en la actividad están dados de alta en el fichero APPIAN del delegado.<asp:HyperLink ID="HyperLink2" onclick="javascript:mostrarDescGENESYS(this);"
    runat="server" class="eosVerMas contentMoreInfo">+</asp:HyperLink></label>
                                    <div class="radioCheck">
                                        <asp:RadioButtonList ID="rbMedicosGenesys" RepeatLayout="Flow" RepeatDirection="Horizontal"
                                            runat="server" CellSpacing="10">
                            ...
                            <div class="contentFormGeneric">
                                <div class="contentForm eosUnoColumna">
                                    ...
                                    <asp:TextBox ID="txtgastoDesglose" runat="server" CssClass="eosDisabledInputVacio eosInputVacioGastos large-text-area "
                            ...
                            <div>
                                <div align="left">
                                    <asp:ImageButton ID="btnExportarInfoExpediente" Style="margin-left: 20px" runat="server"
            ...
            <asp:Panel ID="Panel9" runat="server">
                <div class="contentFormGeneric">
                    <div class="contentForm eosUnoColumna">
                        ...
                        <div class="radioCheck"><asp:CheckBox ID="chkDocAdicional" onclick="javascript:docAdicional(this);" runat="server"
                            Text=" " /></div>
                    </div>
                </div>
                <% if (DocAdicional())
                ...
                <div id="DocAdicional">
                    ...
                    <div id="DocAdicional" style="display: none">
                        <% } %>
                        <div id="Div7" class="eosFiltroColor">
                            <div class="eosFiltroColorTabla">
                                <div style="text-align: center;">
                                    <div id="Table4" class="contentTableGeneric" style="margin-top: 24px;">
                                        <asp:ListView ID="lvDocumentacion" runat="server" DataSourceID="odsDocumentacion"
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="min-width: 53px;">
                                                        ...
                                                        <asp:ImageButton Text="Descargar" ID="ImgDescargarDoc" runat="server" ImageUrl="~/Styles/images/download.png"
                                                            ToolTip='<%# String.Format("Descargar Documento") %>' CommandName='<%# Eval("nombredoc") %>'
                                ...
                                <div id="tablas">
                                    <div id="Table5" class="eosTablaFiltros">
                                        ...
                                        <div class="contentFormGeneric">
                                            <div class="contentForm eosMitadColumna">
                                                <label id="lblArchivoDocumento" class="eosCampoLabelSin"
                                                    title="Archivo">
                                                    Documento</label>
                                                <asp:FileUpload ID="fuploadDocumentacion" runat="server" />
                                            </div>
                                            <div class="contentForm eosMitadColumna">
                                                 <label id="lblCategoriaDocumento" class="eosCampoLabelSin"
                                                     title="Archivo">
                                                     Categoría</label>
                                        ...
                                        <div id="chkAdjuntarFarma" style="display: none">
                                            <div class="contentFormGeneric">
                                                <div class="contentForm eosUnoColumna">
                                                    <label id="Label8" class="eosCampoLabelSin"
                                                        title="Archivo">
                                                        Adjuntar a Email para Farmaindustria</label>
                                                    <div class="radioCheck" style="margin-bottom: 24px;">
                                        ...
                                        <div id="DescEnviarMails" style="display: none">
                                            <div>
                                                <label id="Label4" class="eosTituloWizard">
                                        ...
                                        <div class="contentFormGeneric">
                                            <div class="contentForm eosUnoColumna">
                                                ...
                                                <asp:TextBox ID="txtComentarioDoc" Visible="true" TextMode="MultiLine" runat="server"
                                                    MaxLength="500" style="margin: 0; margin-bottom: 24px;" CssClass="eosDisabledInputVacio eosInputVacio eosSizeW360 large-text-area"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div id="trGuardarDocumentacio" class="eosBotonera eosBotonFiltrado">
                                    ...
                                    <div>
                                        <div>
                                            <div>
                                                <label id="Label16" class="eosCampoLabelSin">
                                                    Recuerda esta otra documentación que debes adjuntar
                                                </label>
                                                <label id="Label22" class="eosCampoLabelSin">
                                                    fuera de EOS</label>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div>
                                                <label id="Label18" class="eosCampoLabelSin">
                                                    -Convenio de Colaboración con Instituciones (Archivo Legal-Mis Contratos)</label>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <label id="Label19" class="eosCampoLabelSin">
                                                    -Contrato Consultores (Archivo Legal-Mis Contratos)</label>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <label id="Label20" class="eosCampoLabelSin">
                                                    -Contrato Advisory Boards (Archivo Legal-Mis Contratos)</label>
                                            </div>
                                        </div>
                                        <div>
                                            <div style="border: 0">
                                                <label id="Label21" class="eosCampoLabelSin">
                                                    -Contrato Ponente (Archivo Legal-Mis Contratos)</label>
                                            </div>
                                        </div>
                                        <div>
                                            <div>
                                                <label id="Label23" class="eosCampoLabelSin">
                                                    -Minutas de las reuniones de Asesores (Archivo Unidad de Negocio)</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <asp:Panel ID="plAMEC_Comentarios" runat="server" Visible="false">
                ...
                <div id="Div8" class="eosFiltroColor">
                    <div class="eosFiltroColorTabla contentTableGeneric">
                        <table id="Table7" class="eosTablaFiltros">
                            <asp:ListView ID="lvComentarios" runat="server" DataSourceID="odsComentariosAMEC"
                                EnablePersistedSelection="True" DataKeyNames="IDAMECS">
                                <EmptyDataTemplate>
                                    <table style="margin-top: 20px" class="eosTablaResultados">
                                        <thead>
                        ...
                        <div class="contentFormGeneric">
                            <div class="contentFormGeneric eosMitadColumna">
                                <label id="lblComentario" class="eosCampoLabelSin">
                                    Comentario</label>
                                <asp:TextBox ID="txtComentario" Visible="true" TextMode="MultiLine" runat="server"
                                    MaxLength="200" CssClass="eosDisabledInputVacio eosInputVacio eosSizeW220 large-text-area" style="margin: 0; margin-bottom: 24px;"></asp:TextBox>
                            </div>
                            <div>
                        ...
                        <div id="Div9" class="eosFiltroColor">
                            <div class="eosFiltroColorTabla contentTableGeneric">
                                <table id="Table9" class="eosTablaFiltros">
                                    <asp:ListView ID="lvFlujo" runat="server" DataSourceID="odsHistEstadosAMEC" EnablePersistedSelection="True"
                                        ...
                                        <LayoutTemplate>
                                            <table class="eosTablaResultados">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                            <asp:LinkButton ID="lbAccion" runat="server" Text="ACCION" CommandName="Sort" CommandArgument="ACCION"></asp:LinkButton>
                                                        </th>
                                                        <th>
                                                            <asp:LinkButton ID="lbUsuario" runat="server" Text="USUARIO" CommandName="Sort" CommandArgument="USUARIO"></asp:LinkButton>
                                                        </th>
                                                        ...
                                                        <th>
                                                            <asp:LinkButton ID="lbFechaUltimaAccion" runat="server" Text="FECHAULTIMAACCION"
                        ...
                        <div>
                            <div>
                                <div class="eosDivCentrada">
                                    ...
                                    <asp:Button ID="btnClonar" Visible="false" runat="server" Text="Clonar"
                                        OnClick="btnClonar_Click" ValidationGroup="AMECValidationGroup" />         
                                </div>
                            </div>
                        </div>
                        <div>
        ...
        <asp:ObjectDataSource ID="odsUnidadesOrganizativas" runat="server" SelectMethod="ObtenerUnidadesOrgAMEC"
            TypeName="EOS.Web.AgenteUnidadesOrgAMEC" SelectCountMethod="ObtenerNumeroUnidadesOrgAMEC"
            EnablePaging="True" OnSelecting="odsUnidadesOrganizativas_Selecting" SortParameterName="sortParameter">
            <SelectParameters>
                <asp:Parameter Name="filtroidamec" Type="String" />
                <asp:Parameter Name="filtroidsolicitante" Type="String" />
                ...
                <asp:Parameter Name="filtroAccion" Type="String" />
                <asp:Parameter Name="filtroUnidad" Type="String" />
                <asp:Parameter Name="filtroArea" Type="String" />
