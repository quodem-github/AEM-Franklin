...
namespace EOS
{
    public partial class NuevoExpedientePasoA : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (tipo == "1")
                {
                    ...
                    plTituloInd.Visible = true;
                    plTituloCol.Visible = false;
                    plTituloCalculadora.Visible = false;
                ...
                else if (tipo == "2")
                {
                    ...
                    plTituloInd.Visible = false;
                    plTituloCol.Visible = true;
                    plTituloCalculadora.Visible = false;
                    var calculadoraItem = tipoPagoDropDownList.Items.FindByValue("3");
                    calculadoraItem.Enabled = false;
                }
                else if (tipo == "3")
                {
                    ...
                    plTituloInd.Visible = false;
                    plTituloCol.Visible = false;
                    plTituloCalculadora.Visible = true;
                    //CALCULADORA plPaso1.Visible = false;
                    //CALCULADORA plPaso2.Visible = false;
                ...
                else
                {
                    ...
                    if (tipo == "3")
                    {
                        //CALCULADORA SeleccionaActividad(EOS.ServiceLogic.Variables.CalculadoraIdPeticionActividadDefault, null, out int? idconfempresakk);
                    }
                ...
                {
                    btnCrearNuevaActividad.Visible = false;
                    btnCrearNuevaActividadGP.Visible = false;
                    btnCrearNuevaActividadAmex.Visible = false;
                    if (datosUsuario.IdConfEmpresa != null && datosUsuario.IdConfEmpresa > 0)
                    {
                        btnCrearNuevaActividad.Visible = true;
                        btnCrearNuevaActividad.PostBackUrl = "~/NuevaActividad.aspx?idconf=" + datosUsuario.IdConfEmpresa + "&tipo=" + tipo;
                    }
                    else
                    {
                        btnCrearNuevaActividadGP.Visible = true;
                        btnCrearNuevaActividadGP.PostBackUrl = "~/NuevaActividad.aspx?idconf=1&tipo=" + tipo;
                        btnCrearNuevaActividadAmex.Visible = false;
                    }
                }
        ...
        protected void odsActividades_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
        {
            ...
            e.InputParameters["isGestorInvitados"] = false;
        }
        ...
        protected void btnContinuar_Click(object sender, EventArgs e)
        {
            ...
            if (dExpediente != null)
            {
                ...
                dExpediente.sPedido = !string.IsNullOrEmpty(txtPedido.Text.Trim()) ? txtPedido.Text.Trim() : null;
        ...
        protected void RellenaDatosExpediente(int? idconfempresa)
        {
            ...
            if (dExpediente != null)
            {
                ...
                plPaso3.Visible = (dExpediente.nIDCogreso > 0);
                pnlVinculado.Visible = (dExpediente.nIDCogreso > 0);

                //CALCULADORA if (dExpediente.tipoPagoFee == 3 || Request.QueryString["tipo"] == "3")
                //CALCULADORA {
                //CALCULADORA plPaso1.Visible = false;
                //CALCULADORA plPaso2.Visible = false;
                //CALCULADORA }
