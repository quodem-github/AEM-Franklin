...
namespace EOS.Api
{
    public class TiposCongresoController : ApiController
    {
        private IServiceBase _service;
        private readonly AgencyKeyService _agencyKeyService;

        public TiposCongresoController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new TipoCongresoService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposCongresoController.GetList " + ex.Message + " - " + ex.StackTrace);
