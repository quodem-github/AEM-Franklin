...
namespace EOS.Api
{
    public class TiposActividadController : ApiController
    {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new TipoActividadService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TipoServicioController.GetList " + ex.Message + " - " + ex.StackTrace);
