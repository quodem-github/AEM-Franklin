...
namespace EOS.Api
{
    public class TiposPatrocinioController : ApiController
    {
        ...
        public TiposPatrocinioController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new TiposPatrocinioService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposPatrocinioController.GetList " + ex.Message + " - " + ex.StackTrace);
