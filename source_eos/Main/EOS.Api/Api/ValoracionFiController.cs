    ...
    public class ValoracionFiController : ApiController
    {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new ValoracionFiService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio ValoracionFiController.GetList " + ex.Message + " - " + ex.StackTrace);
