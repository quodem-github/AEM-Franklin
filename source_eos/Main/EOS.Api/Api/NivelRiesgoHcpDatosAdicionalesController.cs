...
namespace EOS.Api
{
    public class NivelRiesgoHcpDatosAdicionalesController : ApiController
    {
        ...
        public NivelRiesgoHcpDatosAdicionalesController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new NivelRiesgoHCPDatosAdicionalesService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio NivelRiesgoHcpDatosAdicionalesController.GetList " + ex.Message + " - " + ex.StackTrace);
