...
namespace EOS.Api
{
    public class ServiciosReservasViajesController : ApiController
    {

        private IService _service;
        private readonly AgencyKeyService _agencyKeyService;

        public ServiciosReservasViajesController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new ServiciosReservasViajesService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio ServiciosReservasViajesController.GetList " + ex.Message + " - " + ex.StackTrace);
        ...
        public HttpResponseMessage Edit([FromBody] ReceivedData encryptedFilter)
        {
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio ServiciosReservaViajesController.Edit " + ex.Message + " - " + ex.StackTrace);
