...
namespace EOS.Api
{
    public class TiposReservasWebController : ApiController
    {
        ...
        public TiposReservasWebController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new TiposReservasWebService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposReservasWebController.GetList " + ex.Message + " - " + ex.StackTrace);
