...
namespace EOS.Api
{
    public class TipoActividadPaxDatosAdicionalesController : ApiController
    {
        ...
        public TipoActividadPaxDatosAdicionalesController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new TipoActividadPaxDatosAdicionalesService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio ComunidadController.GetList " + ex.Message + " - " + ex.StackTrace);
