...
namespace EOS.Api
{
    public class TarifasAlojamientoController : ApiController
    {
        private IService _service;
        private readonly AgencyKeyService _agencyKeyService;

        public TarifasAlojamientoController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new TarifaAlojService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TarifasAlojController.GetList " + ex.Message + " - " + ex.StackTrace);
        ...
        public HttpResponseMessage Edit([FromBody] ReceivedData encryptedFilter)
        {
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TarifasAlojamientoController.Edit " + ex.Message + " - " + ex.StackTrace);
