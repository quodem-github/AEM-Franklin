...
namespace EOS.Api
{
    public class DatosadicionalesReservasPassengerController : ApiController
    {
        ...
        public DatosadicionalesReservasPassengerController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new DatosAdicionalesReservasPassengerService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio DatosAdicionalesReservasPassengerController.GetList " + ex.Message + " - " + ex.StackTrace);
