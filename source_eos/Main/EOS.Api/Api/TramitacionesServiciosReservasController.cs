...
namespace EOS.Api
{
    public class TramitacionesServiciosReservasController : ApiController
    {
        private IService _service;
        private readonly AgencyKeyService _agencyKeyService;

        public TramitacionesServiciosReservasController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new TramitacionesServiciosReservasService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TramitacionesServiciosReservasController.GetList " + ex.Message + " - " + ex.StackTrace);
        ...
        public HttpResponseMessage Edit([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                if (encryptedFilter == null || string.IsNullOrEmpty(encryptedFilter.Data))
                {
                    result.AddError(ErrorCode.NullFilter, Utility.GetDisplayName(typeof(ErrorCode), ErrorCode.NullFilter.ToString()));
                    return Request.CreateResponse(HttpStatusCode.BadRequest, result);
                }
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TramitacionesServiciosReservasController.Edit " + ex.Message + " - " + ex.StackTrace);
