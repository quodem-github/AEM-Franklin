...
namespace EOS.Api
{
    public class TiposPRVController : ApiController
    {
        private IService _service;
        private readonly AgencyKeyService _agencyKeyService;

        public TiposPRVController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new TiposPRVService( agencyKey, token );
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposPRVController.GetList " + ex.Message + " - " + ex.StackTrace);
        ...
        public HttpResponseMessage Edit([FromBody] ReceivedData encryptedFilter)
        {
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposPRVController.Edit " + ex.Message + " - " + ex.StackTrace);
