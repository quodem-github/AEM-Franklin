...
namespace EOS.Api
{
    public class TarifasInscripcionController : ApiController
    {
        private IService _service;
        private readonly AgencyKeyService _agencyKeyService;

        public TarifasInscripcionController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new TarifasInscripcionService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TarifasInscripcionController.GetList " + ex.Message + " - " + ex.StackTrace);
        ...
        public HttpResponseMessage Edit([FromBody] ReceivedData encryptedFilter)
        {
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TarifasInscripcionController.Edit " + ex.Message + " - " + ex.StackTrace);
