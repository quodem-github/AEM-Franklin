...
namespace EOS.Api
{
    public class TiposHabitacionController : ApiController
    {
        ...
        public TiposHabitacionController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new TiposHabitacionService(agencyKey, token );
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposHabitacionController.GetList " + ex.Message + " - " + ex.StackTrace);
