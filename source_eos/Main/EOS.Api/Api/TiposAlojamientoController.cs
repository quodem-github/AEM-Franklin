...
namespace EOS.Api
{
    public class TiposAlojamientoController : ApiController
    {
        private IService _service;
        private readonly AgencyKeyService _agencyKeyService;

        public TiposAlojamientoController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new TiposAlojamientoService(agencyKey,token);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposAlojamientoController.GetList " + ex.Message + " - " + ex.StackTrace);
        ...
        public HttpResponseMessage Edit([FromBody] ReceivedData encryptedFilter)
        {
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio TiposAlojamientoController.Edit " + ex.Message + " - " + ex.StackTrace);
