...
namespace EOS.Api
{
    public class MensajesReservasPassengerDatosAdicionalesController : ApiController
    {
        ...
        public MensajesReservasPassengerDatosAdicionalesController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new MensajeReservasPassengerDatosAdicionalesService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio MensajeReservasPassengerDatosAdicionalesController.GetList " + ex.Message + " - " + ex.StackTrace);
