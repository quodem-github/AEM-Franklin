...
namespace EOS.Api
{
    public class NivelRiesgoHcpController : ApiController
    {
        ...
        public NivelRiesgoHcpController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new NivelRiesgoHCPService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio NivelRiesgoHcpController.GetList " + ex.Message + " - " + ex.StackTrace);
