...
namespace EOS.Api
{
    public class ConfEmpresaController : ApiController
    {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
                ...
                _service = new ConfEmpresaService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio ConfEmpresaController.GetList " + ex.Message + " - " + ex.StackTrace);
