...
namespace EOS.Api
{
    public class TipoAsistenteDatosAdicionalesController : ApiController
    {
        ...
        public TipoAsistenteDatosAdicionalesController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new TipoAsistenteDatosAdicionalesService(token, agencyKey);
