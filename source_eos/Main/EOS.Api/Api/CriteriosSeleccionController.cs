...
namespace EOS.Api
{
    public class CriteriosSeleccionController : ApiController
    {
        ...
        public CriteriosSeleccionController()
        {
        ...
        public HttpResponseMessage GetList([FromBody] ReceivedData encryptedFilter)
        {
            ...
            try
            {
               //Obtengo el Token y la agencia.
                ...
                _service = new CriteriosSeleccionService(token, agencyKey);
            ...
            {
                Quodem.Monitor.Alerta.WriteLog("Error servicio CriteriosSeleccionController.GetList " + ex.Message + " - " + ex.StackTrace);
